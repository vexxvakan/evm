...
// BankKeeper_HasDenomMetaData_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasDenomMetaData'
type BankKeeper_HasDenomMetaData_Call struct {
	*mock.Call
}

// HasDenomMetaData is a helper method to define mock.On call
//   - ctx context.Context
//   - denom string
func (_e *BankKeeper_Expecter) HasDenomMetaData(ctx interface{}, denom interface{}) *BankKeeper_HasDenomMetaData_Call {
	return &BankKeeper_HasDenomMetaData_Call{Call: _e.mock.On("HasDenomMetaData", ctx, denom)}
}

func (_c *BankKeeper_HasDenomMetaData_Call) Run(run func(ctx context.Context, denom string)) *BankKeeper_HasDenomMetaData_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *BankKeeper_HasDenomMetaData_Call) Return(_a0 bool) *BankKeeper_HasDenomMetaData_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BankKeeper_HasDenomMetaData_Call) RunAndReturn(run func(context.Context, string) bool) *BankKeeper_HasDenomMetaData_Call {
	_c.Call.Return(run)
	return _c
}
